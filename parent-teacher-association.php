...
$tableHtml = cmsGhaziabadSectionTableHtml('parent-teacher-association-page-ghaziabad');
?>
<html lang="en">
...
<head>
    ...
    <link rel="canonical" href="https://allenhouseghaziabad.com/parent-teacher-association" />
    <title>AllenHouse Ghaziabad| Parent Teacher Association</title>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse overflow-x-auto whitespace-nowrap">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="parent-teacher-association" class="ms-1 sm:text-sm text-xs font-medium text-blue-main">Parent
