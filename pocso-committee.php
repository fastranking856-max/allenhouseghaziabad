...
$tableHtml = cmsGhaziabadSectionTableHtml('pocso-committee-page-ghaziabad');
?>
<html lang="en">
...
<head>
    ...
    <title>AllenHouse Ghaziabad | POCSO Committee</title>
    <link rel="canonical" href="https://allenhouseghaziabad.com/pocso-committee" />
...
<body>
    ...
    <div class="main relative sm:top-[20px] mb-[120px] mx-0 sm:mx-2">
            ...
            <ol
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="pocso-committee"
                            class="ms-1 sm:text-sm text-xs font-medium text-blue-main">POCSO Committee</a>
                    </div>
                </li>
            </ol>
        </div>
