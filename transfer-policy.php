...
$transfer_page = cmsFetchGhaziabadPage('transfer-policy-page-ghaziabad');
$transfer_parts = cmsExtractPageParts($transfer_page);
$policy_content = $transfer_parts['content_html'] !== '' ? $transfer_parts['content_html'] : $transfer_parts['table_html'];
?>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="canonical" href="https://allenhouseghaziabad.com/transfer-policy" />
    <title>AllenHouse Ghaziabad| Transfer Policy</title>
