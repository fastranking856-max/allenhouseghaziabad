...
$tableHtml = cmsGhaziabadSectionTableHtml('teachers-details-page-ghaziabad');
?>
<html lang="en">
...
<head>
    ...
    <link rel="canonical" href="https://allenhouseghaziabad.com/teachers-details" />
    <title>AllenHouse Ghaziabad | Teacher's Details's</title>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse overflow-x-auto whitespace-nowrap">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="teachers-details" class="ms-1 sm:text-sm text-xs font-medium text-blue-main">Teacher
                            Details</a>
                    </div>
                </li>
            </ol>
