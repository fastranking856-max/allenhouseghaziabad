...
<head>
    ...
    <title>AllenHouse Ghaziabad| Campus Tour</title>
    <link rel="canonical" href="https://allenhouseghaziabad.com/campus-tour" />
...
<body>
    ...
    <div class="main relative  mb-[40px] sm:mb-[120px] ">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="campus-tour" class="ms-1 text-xs sm:text-sm font-medium text-blue-main">Campus Tour</a>
                    </div>
                </li>
            </ol>
        </div>
        ...
        <div class="mt-10 mx-4 2xl:w-[1280px] lg:w-[1024px] md:w-[767px] sm:w-[640px] sm:mx-auto sm:px-5 px-4">
            <div class="relative">
                <div class="mt-8 sm:mx-3 2xl:w-[1280px] lg:w-[1024px] md:w-[767px] sm:w-[640px] sm:mx-auto sm:px-5 ">
                    <div >
                        <div
                            class="mt-8 sm:mx-3 2xl:w-[1280px] lg:w-[1024px] md:w-[767px] sm:w-[640px] sm:mx-auto sm:px-5 ">
                            <div >
                                <div class="relative ">
