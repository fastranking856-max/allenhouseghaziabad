...
<head>
    ...
    <link rel="canonical" href="https://allenhouseghaziabad.com/admission-procedure" />
    <!-- <title>Explore Admission Details for Allenhouse School, Ghaziabad</title>
    <meta name="description" content="Get complete admission details for Allenhouse Public School, Ghaziabad - eligibility, documents, and how to apply."> -->
    ...
    <script type="application/ld+json">
{
  ...
  "itemListElement": [{
    ...
    "position": 2,
    "name": "Admissions",
    "item": "https://allenhouseghaziabad.com/admission-procedure"
  }]
}
</script>
    ...
    <div class="main relative mb-[40px] sm:mb-[120px]">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="admission-procedure" class="ms-1 sm:text-sm text-xs font-medium text-blue-main">Admission Procedure</a>
                    </div>
                </li>
            </ol>
        </div>
        ...
        <div class="mt-8 mx-3 2xl:w-[1280px] lg:w-[1024px] md:w-[767px] sm:w-[640px] sm:mx-auto sm:px-5 px-3">
            <div class="sm:mt-10 relative">
                <div class="md:w-[100%]">
                    <p class="mt-5 text-gray-600">Schooling starts at an early age of 2-3 years. Admission to the Nursery class is the initial step towards a long journey. Allenhouse Public School, Ghaziabad, provides an excellent launching pad to every child through a unique education system in Pre-Primary classes.</p>

                    <h3 class="text-[18px] font-semibold mt-5 text-gray-600">Nursery & Prep</h3>
                    <ul class="text-[16px] mt-2 text-gray-600">
                        <li>&#9672 Child should be 2+ years as on 30th September 2025 for admission to Play Group (PG-I).</li>
                        <li>&#9672 Registration is the first step. The prospectus given during Registration gives complete information about the school system.</li>
                        <li>&#9672 Admission to Nursery & Prep will be through informal interaction with the parents and the child. The date and timing for the interaction will be intimated telephonically.</li>
                        <li>&#9672 A list of selected candidates will be displayed at the administrative office. Parents will also be informed telephonically.</li>
                        <li>&#9672 On confirmation of admission, parents will be required to deposit the fee within two days, failing which the admission shall stand cancelled.</li>
                    </ul>

                    <h3 class="text-[18px] font-semibold mt-5 text-gray-600">Important Documents To Be Attached At The Time Of Registration</h3>
                    <ul class="text-[16px] mt-2 text-gray-600">
                    ...
                    <h3 class="text-[18px] font-semibold mt-5 text-gray-600">For Classes I – IX</h3>
                    <ul class="text-[16px] mt-2 text-gray-600">
                        <li>&#9672 Registration is the first step. The prospectus given during Registration gives complete information about the school system.</li>
                        <li>&#9672 Admission to classes I & above is given based on the result of an admission test conducted by the school and the interaction of students & parents with the Principal of shortlisted students.</li>
                        <li>&#9672 The date, Time, & Syllabus for the admission test may be collected from the school administrative office at the time of Registration.</li>
                        <li>&#9672 The Admission Test result will be displayed at the school's Administrative Office within two days of the test.</li>
                    </ul>

                    <h3 class="text-[18px] font-semibold mt-5 text-gray-600">Documents Required At The Time Of Admission</h3>
                    <ul class="text-[16px] mt-2 text-gray-600">
                        ...
                        <li>&#9672 T.C. (original) is to be submitted within one month from the admission date.</li>
                        ...
                        <li>&#9672 Click Here:- <a href="http://apsgzb.superhouseerp.com/RegistrationTransaction/OnlineRegistration">http://apsgzb.superhouseerp.com/RegistrationTransaction/OnlineRegistration</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="relative">
                    ...
                    <div class="mt-10">
                      <form id="AdmissionForm" method="post">
                            <div class="mt-4">
                                <select name="class-selection" required id="asession" class="w-full border border-gray-300 p-2 rounded-md text-gray-500">
...
<?php include "includes/grade-api.php"; ?>
                                </select>
                            </div>
