...
$url = rtrim(CMS_API_URL, '/') . "/document-information/" . BRANCH_ID;
$contextOptions = [
    "ssl" => [
        "verify_peer" => false,
...
<head>
    ...
    <link rel="canonical" href="https://allenhouseghaziabad.com/documents-and-information" />
    <title>AllenHouse Ghaziabad| Document and Information</title>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse overflow-x-auto whitespace-nowrap">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="documents-and-information" class="ms-1 sm:text-sm text-xs font-medium text-blue-main">Documents and Information</a>
                    </div>
                </li>
            </ol>
        </div>
